...
func impuesto(salary float32) {
	...
	Teniendo en cuenta que si la persona gana más de $50.000 se le
	descontará un 17% del sueldo y si gana más de $150.000 se le descontará
	además un 10%.
	*/
	if salary > 50000 && salary < 150000 {
		fmt.Printf("El impuesto del salario es: $%v\n", salary*0.17)
