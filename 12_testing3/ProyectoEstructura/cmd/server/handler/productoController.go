...
import (
	...
	"github.com/extmatperez/meli_bootcamp2/tree/scerca_nahuel/12_testing3/ProyectoEstructura/pkg/web"
		...
		if validado {
			...
			if err == nil {
				if errorCast == nil {
					...
					if errorMod == nil {
						ctx.JSON(200, web.NewResponse(200, fmt.Sprintln("campos modificados correctamente", productoMod), ""))
