...
func Test_StorePersonas(t *testing.T) {
	...
	nuevaTrans := models.Transaccion{Moneda: "pesoArg", Monto: 3014.4, Emisor: "roro", Receptor: "maslata"}
...
func Test_UpdatePersonas(t *testing.T) {
	...
	nuevaTrans := models.Transaccion{Moneda: "pesrg", Monto: 301.4, Emisor: "roasro", Receptor: "masdfglata"}
