...
import (
	...
	"github.com/extmatperez/meli_bootcamp2/9_goweb4/C4_GoWeb/C4-GoWeb-Sincronic/ExampleTT/cmd/server/handler"
...
func main() {
	err := godotenv.Load("/Users/joserios/Desktop/bootcamp/meli_bootcamp2/9_goweb4/C4_GoWeb/C4-GoWeb-Sincronic/ExampleTT/cmd/server/.env")
	if err != nil {
