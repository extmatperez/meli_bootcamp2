...
select serie.title Titulo from series serie;
...
select * from movies where rating >3 and awards >1 and year(release_date) between 1988 and 2009 limit 3 offset 10;
