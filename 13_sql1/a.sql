...
-- Mostrar el título de todas las series y usar alias para que tanto el nombre de 
-- la tabla como el campo estén en español.
...
SELECT title FROM movies WHERE rating > 3 AND awards > 1 AND release_date BETWEEN "1988-01-01" AND "2009-01-01" ORDER BY rating LIMIT 3 OFFSET 10;