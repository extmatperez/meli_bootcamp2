...
func itemToTransaction(input map[string]*dynamodb.AttributeValue) (*models.TransactionDynamo, error) {
	var item models.TransactionDynamo
...
type RepositoryDynamo interface {
	Store(ctx context.Context, model *models.TransactionDynamo) error
	GetOne(ctx context.Context, id string) (*models.TransactionDynamo, error)
...
func (receiver *dynamoRepository) Store(ctx context.Context, model *models.TransactionDynamo) error {
...
func (receiver *dynamoRepository) GetOne(ctx context.Context, id string) (*models.TransactionDynamo, error) {
	...
	return itemToTransaction(result.Item)
}

func (receiver *dynamoRepository) Delete(ctx context.Context, id string) error {
	_, err := receiver.dynamo.DeleteItemWithContext(ctx,
