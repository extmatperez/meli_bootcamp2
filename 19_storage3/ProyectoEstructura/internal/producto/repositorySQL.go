...
func (r *repositorySQL) GetAll(ctx context.Context) ([]models.Producto, error) {
...
func (repsql *repositorySQL) Update(ctx context.Context, producto models.Producto) (models.Producto, error) {
	db := db.StorageDB
